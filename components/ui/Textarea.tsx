  ...
  return (
    <div className="flex w-full flex-col gap-1.5">
      ...
      <textarea
        ...
        className={`min-h-[120px] w-full resize-y rounded-xl border bg-white px-3 py-2 text-gray-900 shadow-sm placeholder:text-gray-400 transition focus:outline-none focus:ring-2 dark:bg-gray-900 dark:text-gray-100 dark:placeholder:text-gray-500 ${
          err
